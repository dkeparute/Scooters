...
function NewScooter({ create }) {
    ...
    return (
        ...
        <div className='new-item'>
            ...
            <div className='each-new-item'>
                <span>New one day ride kilometers: </span> <input type="number" value={inputs.one_day_ride} onChange={(e) => control(e, 'one_day_ride')} required />
            </div>
            <div className='each-new-item'>
                <span>Total ride kilometers: </span> <input type="number" value={inputs.total_ride_kilometers} onChange={(e) => control(e, 'total_ride_kilometers')} />
            </div>
            <div className='each-new-item'>
